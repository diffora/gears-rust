...
use modkit::contracts::{DatabaseCapability, SystemCapability};
...
impl Module for CredStoreModule {
    ...
    async fn init(&self, ctx: &ModuleCtx) -> anyhow::Result<()> {
        ...
        let svc = Arc::new(Service::new(
            ...
            plugins,
            metrics,
            cfg.reaper.tick_secs,
            cfg.reaper.provisioning_timeout_secs,
        ));
...
impl DatabaseCapability for CredStoreModule {
...
impl RestApiCapability for CredStoreModule {
    fn register_rest(
        &self,
        _ctx: &ModuleCtx,
        router: axum::Router,
