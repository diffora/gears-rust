...
use credstore_sdk::{SecretType, SecretTypeRef};
...
impl Service {
    ...
    pub async fn put(
            ...
            .await?
        {
            ...
            if let Some(requested) = opts.secret_type
                && requested.uuid() != existing.secret_type_uuid
            {
        ...
        let type_uuid = opts
            .secret_type
            .map_or_else(|| SecretType::generic().uuid(), SecretTypeRef::uuid);
