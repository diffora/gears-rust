...
| Usage Collector — phase-2 Usage Event Feed | `gears/system/usage-collector/docs/PRD-phase2-usage-event-feed.md` | The UC1 ingestion transport this gear's slice 12 depends on (launch-gating) |
