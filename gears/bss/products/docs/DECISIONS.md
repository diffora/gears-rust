...
- **Date**: 2026-09-21 (owner call). Not breaking on the wire: nothing is removed from this gear's request or response shapes. Pricing's counterpart is **D-382**.
...
- **Propagated**: `design/01-foundation.md` (the bucket-assignment paragraph, which recorded bucket iv as empty) and `design/03-sku-classification.md` (C6's bucket registration, where the tier moves from iii to iv). **Owed**: nothing in this gear's design set; the pricing counterpart's own propagation is **D-382**'s.
