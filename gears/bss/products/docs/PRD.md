...
- **Plan, Price, PriceWindow, PriceList, Bundle composition, add-on rules, billing descriptors (invoice line template / tax category / GL code — the **code** carried on the SKU as a reference to Finance's recognized set stays here under `fr-accounting-codes`; the descriptor does not: **P-D-131**, 2026-09-03), plan lifecycle/migration/grandfathering, plan publish validation & approval, price history** → `PRD-plan-price-modeling-202605281200`.
