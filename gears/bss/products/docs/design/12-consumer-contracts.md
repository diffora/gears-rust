...
- **Five of the nine lints have no harvest grammar.** This slice twice argues that a prose-reading
  lint is unbuildable, and supplies a machine-readable source for exactly the three whose grammar
  was measured broken (1, 6, 9), and P-D-43 has since supplied lint 5's. Lints 2, 3, 4, 7 and 8 remain prose predicates over prose —
