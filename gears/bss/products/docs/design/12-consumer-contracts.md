...
- **~~Five of the nine lints have no harvest grammar.~~ Closed by P-D-45.** Lint 3 reads 05 §3.2's
  ...
  declarations). Lint 2's input set had already landed with P-D-44. All nine now have a source a
  gate can read; what remains is **writing** one of them, which is the item below.
