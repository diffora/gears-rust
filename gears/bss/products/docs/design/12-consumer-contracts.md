...
- **Does this slice owe an open-item reciprocity lint?** Design 01 §6 files questions to sibling
  documents as "pointer only — each registered where its owner will look". On 2026-08-28 that claim was
