...
**Risks & open items**:
- **Open above this slice: does browse need a separate serving store at all?** *(P-D-132, 2026-09-03: the workshop's; DRI and date to be named by the Program Lead.)* Raised in review and now a PRD §15 question for the NFR workshop. `fr-cache-first-browse`'s
