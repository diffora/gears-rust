...
| # | Constraint | Source |
|---|-----------|--------|
| C1 | Source may be `draft`, `published`, or `retired` (the revival path); the source is never affected | PRD `fr-clone` |
