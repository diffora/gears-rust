...
- **Decisions**: SUB-D-02 (`updateQuantity`), SUB-D-04 (ramps), SUB-D-15 (manual change supersedes mid-ramp; §4.5), SUB-D-21 (immediate-delta producer; §4.1), SUB-D-26 (cancel+new cohort disclosure; §4.3) — [`../DECISIONS.md`](../DECISIONS.md).
