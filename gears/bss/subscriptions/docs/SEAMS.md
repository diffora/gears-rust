...
> `SUB-D-01…26` live in [`DECISIONS.md`](./DECISIONS.md) (01…12: 2026-07-15 wave; 13…15:
> 2026-07-28 review fixes; 16…19: 2026-07-28 billing pass; 20…26: 2026-08-01 wave-3 fixes);
> the vendor gaps `G-1…G-6` in [`STRIPE-ZUORA-GAP-ANALYSIS.md`](./STRIPE-ZUORA-GAP-ANALYSIS.md).
...
- **SUB-B1 / rating SB1** — the recurring-WHEN owner: rating's period tick (its `design/14`) vs this gear's period fact (SUB-D-07/19/21) — resolve before either gear implements `billingAnchorPolicy` (SUB-P9). *(Added to this checklist 2026-08-01 — wave-3 review #24a/#21.)*
...
- **SUB-P9** — `billingAnchorPolicy` adoption + the K5 joint anchor fixture — gated on the SB1 resolution above.
