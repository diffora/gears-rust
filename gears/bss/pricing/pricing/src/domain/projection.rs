...
///
/// Called `RowTaxProjection` until 2026-08-19, when the rounding policy got a
/// frozen column of its own and joined it: the type is no longer about tax, it is
/// about the values a publish resolved and a consumer must not re-derive.
#[domain_model]
