...
impl PlanMigrationScheduledPayload {
    ...
    pub fn to_value(&self) -> JsonValue {
        json!({
            ...
            "effectiveAt": format_rfc3339_serde(self.effective_at),
            "scope": self.scope,
...
impl PlanPublishDegradedPayload {
    ...
    pub fn to_value(&self) -> JsonValue {
        json!({
            ...
            "pendingVersionRef": self.pending_version_ref,
            "commitObservedAt": format_rfc3339_serde(self.commit_observed_at),
            "correlationId": self.correlation_id,
        })
    }
}
...
impl PriceWindowTransitionPayload {
    ...
    pub fn to_value(&self) -> JsonValue {
        json!({
            ...
            "effectiveFrom": format_rfc3339_serde(self.effective_from),
            "effectiveTo": self.effective_to.map(format_rfc3339_serde),
            "correlationId": self.correlation_id,
        })
    }
}
...
impl PriceUpdatedPayload {
    ...
    pub fn to_value(&self) -> JsonValue {
        json!({
            ...
            "changeover": format_rfc3339_serde(self.changeover),
            "pendingVersionRef": self.pending_version_ref,
            "correlationId": self.correlation_id,
        })
    }
