//! `SeaORM` entity for `bss.pricing_partner_taxonomy` — the partner value universe D-120 added — before it, the axis selecting *who receives an adjustment* was a free-form string
//! (`design/04-currency-tax.md` §6).
//!
//! **Slice 4's table**, carried on the Slice 9 chain because `inst-plv-scope`
//! validates against it and it did not exist; `pricing_brand_taxonomy`'s sibling
...
#[sea_orm(table_name = "pricing_partner_taxonomy")]
#[secure(
