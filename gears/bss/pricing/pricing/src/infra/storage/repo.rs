...
//!
//! Five land ahead of the paths that call them, and for the same reason: each
...
//! let two authors edit one draft and both satisfy their precondition. None of
//! those guards survives being reimplemented per call site — that is what makes
//! them repositories and not helpers.
//!
