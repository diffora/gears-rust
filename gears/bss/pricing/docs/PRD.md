...
**Tenant defaults (D-373):** `pricing_policy_object.default_gl_code_ref` is nullable; `default_line_templates` ships with these four ASCII literals, keyed by `charge_kind`:
