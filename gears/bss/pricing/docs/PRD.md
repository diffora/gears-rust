...
**Direction**: provided by this PRD to Subscriptions — **two-way**: **two** inbound lanes — (1) grandfathering re-bind reporting (recorded 2026-07-28, previously implicit) and (2) the **migration execution handshake** (D-65, recorded 2026-07-29: execution-start declaration + processed-scope report)
