...
Resolve returns every item's default/value inputs and active promotion version without totals. Usage consumers bind lazily by value rather than choosing one value for the plan (spec §7.1).
