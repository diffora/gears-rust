...
| Phase 4: an unknown or another tenant's revision; an item_id the revision does not have; a price that is not an approved price of the tenant | 404, before any Products read; 404; 404 with one body for a draft, pending, rejected, unknown or foreign price (D-422) |
...
All four ADRs are cited in §1.2. [PRD](PRD.md) owns requirements; [DECISIONS](DECISIONS.md) owns D-384–D-423.
