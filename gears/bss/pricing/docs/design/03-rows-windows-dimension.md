...
5. PRD AC #6 / `cpt-cf-bss-pricing-dod-pair-guard`: Given a package predecessor, when only its amount changes then validation passes; a size, model or unit change returns 422 CHAIN_MODEL_CHANGED.
